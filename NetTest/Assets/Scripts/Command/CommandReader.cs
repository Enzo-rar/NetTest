...
public class CommandReader : MonoBehaviour
{
    ...
    private void ActivarModoHeadless()
    {
        ...
        // Unity tiene un argumento nativo llamado "-batchmode" que desactiva el renderizado gr�fico.
        // Usaremos "-batchmode" nativo en AWS, pero este "-headless" sirve para apagar cosas 
        // l�gicas del juego que "-batchmode" no apaga (como el audio o UI espec�ficas).
    }
}